...
export const AppLayout: React.FC<AppLayoutProps> = ({ children }) => {
  ...
  const allScreens = [
    ...
    { num: 6, name: "6. Register - Basic Info", path: "/registration" },
    { num: 7, name: "7. Register - Contact Info", path: "/register/contact" },
    { num: 8, name: "8. Register - Address & Ward", path: "/register/address" },
    { num: 9, name: "9. OTP Verification", path: "/otp" },
    { num: 10, name: "10. Location Permission", path: "/location-permission" },
    { num: 11, name: "11. Appearance Selection", path: "/choose-appearance" },
    { num: 12, name: "12. Home Dashboard", path: "/home" },
    { num: 13, name: "13. Navigation Drawer", path: "/drawer" },
    { num: 14, name: "14. Community Feed", path: "/community-feed" },
    { num: 15, name: "15. Community Post Create", path: "/community-feed/create" },
    { num: 16, name: "16. Community Post Detail", path: "/community-feed/post/1" },
    { num: 17, name: "17. Notices & Announcements", path: "/notifications" },
    { num: 18, name: "18. Global Search", path: "/search" },
    { num: 19, name: "19. Complaints Home", path: "/civic" },
    { num: 20, name: "20. Report Issue - Step 1", path: "/complaints/camera" },
    { num: 21, name: "21. Report Issue - Step 2", path: "/complaints/category-details" },
    { num: 22, name: "22. Issue Submitted", path: "/complaints/submitted" },
    { num: 23, name: "23. My Reported", path: "/complaints" },
    { num: 24, name: "24. Complaint Detail", path: "/complaints/comp_1" },
    { num: 25, name: "25. Recent Alerts", path: "/alerts" },
    { num: 26, name: "26. Alert Detail", path: "/alerts/1" },
    { num: 27, name: "27. SOS Emergency", path: "/sos" },
    { num: 28, name: "28. Emergency Contacts List", path: "/emergency-contacts" },
    { num: 29, name: "29. Emergency Contact Detail", path: "/emergency-contact/1" },
    { num: 30, name: "30. Explore Hub", path: "/explore" },
    { num: 31, name: "31. Places List", path: "/places" },
    { num: 32, name: "32. Place Detail", path: "/places/1" },
    { num: 33, name: "33. Explore Food", path: "/food" },
    { num: 34, name: "34. Food Vendor Detail", path: "/food/1" },
    { num: 35, name: "35. Service Directory", path: "/services" },
    { num: 36, name: "36. Service Provider Detail", path: "/services/gov1" },
    { num: 37, name: "37. Live Updates", path: "/live-updates" },
    { num: 38, name: "38. Transport Hub", path: "/transport" },
    { num: 39, name: "39. Transit Schedules", path: "/transport/detail" },
    { num: 40, name: "40. Community Hub", path: "/community" },
    { num: 41, name: "41. Volunteer Register", path: "/volunteer/register" },
    { num: 42, name: "42. Volunteer Directory", path: "/volunteers" },
    { num: 43, name: "43. Donations List", path: "/donations" },
    { num: 44, name: "44. Donation Detail", path: "/donations/1" },
    { num: 45, name: "45. Post Donation Request", path: "/donations/create" },
    { num: 46, name: "46. Blood Request Form", path: "/blood-request/create" },
    { num: 47, name: "47. Blood Broadcast Detail", path: "/blood-request/1" },
    { num: 48, name: "48. Jobs & Rentals Hub", path: "/jobs-rentals" }
  ];
